...
from loaded_intent_classifier import intent_classifier
from loaded_entity_recognition import entity_recognition
...
def index():
    if request.method == 'POST':
        ...
        intent = intent_classifier([msg])
        entity = entity_recognition(msg)
        
        print(intent, entity)
        
        
        
        msg = '너가 말한 범주는 {msg_intent} (이)고, 너의 대화에서 추출한 객체명은\
        {msg_entity} 야'.format(msg_intent=intent, msg_entity=entity)
